...
public class NcssReportMojo extends AbstractMavenReport {
     ...
     * @throws org.apache.maven.reporting.MavenReportException report issue
     */
    @Override
    ...
    /**
     * If the report can be made
     *
     * @return if the report can be made
     */
    @Override
    ...
    /**
     * Gets the name
     * @param locale the language local
     * @return String
     */
    @Override
